...
public class Project3 {
  ...
  public static void main(String[] args) {
    ...
    double nauticalMiles = (90.0 * 60.0 / 10000.0)
        * kilometers; // 90 degrees times 60 minutes of arc between the North Pole and the equator, divided by a thousand because a kilometer is 1/10,000 of the distance between the North Pole and the equator, multiplied by the number of kilometers.
