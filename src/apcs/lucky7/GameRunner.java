...
public class GameRunner {
  ...
  public static void main(String[] args) {
    ...
    String[] feelings = {"risky", "amused", "pleased", "charmed", "delighted", "glad", "optimistic",
        "joyful", "enthusiastic"}; // Potential house emotions
    ...
    System.out.println(
        "Each round, you roll 2 d" + dice + ". If you roll a(n) " + diceType + ", you win $5.");
    ...
    while (true) {
      ...
      for (count = 0; newBalance > 0; count++) {
        ...
        System.out
            .print("Roll #" + (count + 1) + ": " + r1 + ", " + r2 + "   Total: " + total + " = ");
      ...
      System.out.println(
          "You should have stopped after " + highestRound + " roll(s) when your balance was $"
              + highestBalance + ".");
