...
public class PiRunner {
    public static void main(String[] args) {
        ...
        while((4 / denominator2) > threshold) { // Only proceed when the threshold isn't met for the term
            int sign = (positive) ? 1 : -1; // Convert boolean of positive/not positive to make it so that you can multiply it in the equation
        ...
        System.out.println("PI approximated until a term is less than " + threshold + " is " + approximation);
        ...
        System.out.println("Pi/4 is approximately " + inCircle + "/" + totalPairs + " = " + approximate);
